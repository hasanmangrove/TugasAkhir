                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                    $no = 0;
                                    foreach ($aset_tanah as $i){ ?>
                                        <tr>
                                            <td><?php echo $i->no_persil; ?></td>
                                            <td><?php echo $i->kepemilikan; ?></td>
                                            <td><?php echo $i->atasnama_sertifikat; ?></td>
                                            <td><?php echo $i->status_tanah; ?></td>
                                            <td><?php echo $i->luas_tanah; ?></td>
                                            <td><?php echo $i->no_sertifikat; ?></td>
                                            <td><?php echo $i->tgl_sertifikat; ?></td>
                                            <td><?php echo $i->thn_perolehan; ?></td>
                                            <td><?php echo $i->harga_perolehan; ?></td>
                                            <td><?php echo $i->asal_usul; ?></td>
                                            <td><?php echo $i->letak; ?></td>
                                            <td><?php echo $i->peruntukan; ?></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
