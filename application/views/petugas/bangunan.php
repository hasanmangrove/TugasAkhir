                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                    $no = 0;
                                    foreach ($aset_bangunan as $i){ ?>
                                        <tr>
                                            <td><?php echo ++$no; ?></td>
                                            <td><?php echo $i->nama_bangunan; ?></td>
                                            <td><?php echo $i->kode_bangunan; ?></td>
                                            <td><?php echo $i->register_bangunan; ?></td>
                                            <td><?php echo $i->kondisi_bangunan; ?></td>
                                            <td><?php echo $i->luas_lantai; ?></td>
                                            <td><?php echo $i->lokasi; ?></td>
                                            <td><?php echo $i->tahun_pembangunan; ?></td>
                                            <td><?php echo $i->luas_bangunan; ?></td>
                                            <td><?php echo $i->biaya_pembangunan; ?></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
