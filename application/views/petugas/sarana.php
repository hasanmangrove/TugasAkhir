                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    foreach ($sarana as $i){ ?>
                                        <tr>
                                            <td><?php echo ++$no; ?></td>
                                            <td><?php echo $i->nama_prasarana; ?></td>
                                            <td><?php echo $i->jumlah; ?></td>
                                            <td><?php echo $i->kondisi_baik; ?></td>
                                            <td><?php echo $i->kondisi_rusakringan; ?></td>
                                            <td><?php echo $i->kondisi_rusaksedang; ?></td>
                                            <td><?php echo $i->kondisi_rusakberat; ?></td>
                                            <td><?php echo $i->kondisi_sarpras; ?></td>
                                            <td><?php echo $i->status_kepemilikan; ?></td>
                                            <td><?php echo $i->tahun_pengadaan; ?></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
