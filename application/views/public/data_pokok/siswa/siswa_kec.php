                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <table id="datatable-buttons" name="table-data" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                    // menangkap id provinsi dari url
                                    ...
                                    foreach ($siswa as $i){?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo base_url('beranda/detail_siswa/'.$i['npsn'])?>">
                                                    <?php echo $i['nama_sekolah']; ?>
                                                </a>
                                            </td>
                                            <td><?php
                                                if(isset($i['jumlah_putra'])){
                                                    echo $i['jumlah_putra'];
                                                    $sum += $i['jumlah_putra'];
                                                } else {
                                                    echo '0';
