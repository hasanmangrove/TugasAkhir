...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo base_url('assets/vendors/iCheck/flat/blue.css'); ?>">
    <!-- Morris chart -->
    <link rel="stylesheet" href="<?php echo base_url('assets/vendors/morris/morris.css'); ?>">
    <!-- jvectormap -->
    <link rel="stylesheet" href="<?php echo base_url('assets/vendors/jvectormap/jquery-jvectormap-1.2.2.css'); ?>">
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?php echo base_url('assets/vendors/datepicker/datepicker3.css'); ?>">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo base_url('assets/vendors/daterangepicker/daterangepicker-bs3.css'); ?>">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="<?php echo base_url('assets/vendors/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css'); ?>">
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('assets/vendors/knob/jquery.knob.js'); ?>"></script>
<!-- daterangepicker -->
...
<!-- FastClick -->
<script src="<?php echo base_url('assets/vendors/fastclick/fastclick.min.js'); ?>"></script>
<!-- AdminLTE App -->
